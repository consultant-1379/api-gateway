...
import com.ericsson.gateway.exception.StartUpException;
...
public class RenameDefaultGenerationEntrypoints {
  ...
  private static Logger logger = LoggerFactory.getLogger(RenameDefaultGenerationEntrypoints.class);
  ...
  public static void disableGeneratedPages(ServerHttpSecurity http) throws StartUpException {
