...
public class TenantAwareOAuth2AuthorizationRequestRedirectWebFilter implements WebFilter {
  ...
  private ServerAuthorizationRequestRepository<OAuth2AuthorizationRequest>
  ...
  public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
    return this.authorizationRequestResolver
        ...
        .onErrorResume(
            ...
            e -> this.authorizationRequestResolver.resolve(exchange, e.getClientRegistrationId()))
        .flatMap(
            clientRegistration -> this.sendRedirectForAuthorization(exchange, clientRegistration));
  }
